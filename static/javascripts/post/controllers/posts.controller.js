...
(function() {
  ...
  function PostsController($scope) {
     ...
     * @memberOf thinkster.post.controllers.PostsController
     */
    function activate() {
     ...
     * @memberOf thinkster.post.controllers.PostController
     */
    ...
    function approximateShortestColumn() {
       ...
       * @returns The approximately norminalized height of a given column
       */
